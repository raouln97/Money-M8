...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { BankInformationController } from './../src/BankInfo/bankInfo.controller';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/auth/signUp',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"SignUpBodyDTO"},
            };
        ...
        app.post('/auth/signIn',
            ...
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"SignInBodyDTO"},
        ...
        app.post('/auth/logout',
            ...
            const args = {
                    customResponse: {"in":"res","name":"200","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string","required":true}}},
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/auth/forgetPassword',
            ...(fetchMiddlewares<RequestHandler>(Authcontroller)),
            ...(fetchMiddlewares<RequestHandler>(Authcontroller.prototype.forgetPassword)),

            function Authcontroller_forgetPassword(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"ForgetPasswordDTO"},
            };
            ...
            try {
              ...
              const promise = controller.forgetPassword.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/bank',
            ...(fetchMiddlewares<RequestHandler>(BankInformationController)),
            ...(fetchMiddlewares<RequestHandler>(BankInformationController.prototype.getAllBanks)),

            function BankInformationController_getAllBanks(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new BankInformationController();
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/creditCard',
            ...(fetchMiddlewares<RequestHandler>(CreditCardInformationController)),
            ...(fetchMiddlewares<RequestHandler>(CreditCardInformationController.prototype.getAllBanks)),

            function CreditCardInformationController_getAllBanks(request: any, response: any, next: any) {
            const args = {
                    bankName: {"in":"query","name":"bankName","required":true,"dataType":"string"},
            };
            ...
            try {
                ...
                const controller = new CreditCardInformationController();
